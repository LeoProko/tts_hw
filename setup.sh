...
# bad link: gdown https://drive.google.com/u/0/uc?id=1cJKJTmYd905a-9GFoo5gKjzhKjUVj83j
gdown https://drive.google.com/u/0/uc?id=1CfSmMgXytShBSmYyEG7-ifDbh4QTtEDD
tar -xvf mel.tar.gz
echo $(ls mels | wc -l)
rm mel.tar.gz
